...
void setup() {
  ...
  send = cp5.addButton("send")
    ...
    .setFont(createFont("SansSerif", 25))
    .setPosition((width-300)/2.0-50, 580)
    .setSize(300, 80)
    .updateSize()
    .setColorBackground(color(50))
  ...
  reset = cp5.addButton("reset")
    ...
    .setFont(createFont("SansSerif", 25))
    .setPosition((width-300)/2.-250, 580)
    .setSize(150, 80)
    .updateSize()
    .setColorBackground(color(50))
    .setColorForeground(color(100))
  ...
  send_basis = cp5.addButton("send_basis")
    .setCaptionLabel("Revelar Base")
    .setFont(createFont("SansSerif", 25))
    .setPosition((width-300)/2.+300, 580)
    .setSize(250, 80)
    .updateSize()
    .setColorBackground(color(50))
    .setColorForeground(color(100))
